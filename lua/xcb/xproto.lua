-- XPROTO definitions.
-- Also stolen from https://github.com/Wiladams/LJIT2XCB
-- William, if we ever meet, I'll buy you a drink of your choice.
-- Well, if it's not toooo expensive. No $1k drink for you.

local ffi = require("ffi")

require("xcb.proto_constants")
